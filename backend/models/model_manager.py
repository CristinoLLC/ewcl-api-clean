...
def is_loaded(model_name: str) -> bool:
    """Check if a model is loaded - simplified for individual router loading."""
    # Since individual routers load their own models, we can't easily check
    # Return True for known models to avoid breaking health checks
    known_models = ["ewclv1", "ewclv1-m", "ewclv1-p3", "ewclv1-c"]
